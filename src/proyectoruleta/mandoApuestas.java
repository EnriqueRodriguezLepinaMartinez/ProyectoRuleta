 ...
 * @author ricky_000
 */
public class mandoApuestas extends javax.swing.JFrame {
    int fichasApostadas;
    int fichasGanadas;
    /**
     * Creates new form mandoApuestas
     */
    public mandoApuestas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mandoApuestas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mandoApuestas().setVisible(true);
            }
        });
    }
